...
def make_supporting_tables(db: duckdb.DuckDBPyConnection) -> None:
    ...
    db.sql("""
        ...
        CREATE TABLE vep (
            ...
            gene VARCHAR,
            gnom_ade_af FLOAT,
            gnom_ade_afr_af FLOAT,
            gnom_ade_amr_af FLOAT,
            gnom_ade_asj_af FLOAT,
            gnom_ade_eas_af FLOAT,
            gnom_ade_fin_af FLOAT,
            gnom_ade_mid_af FLOAT,
            gnom_ade_nfe_af FLOAT,
            gnom_ade_remaining_af FLOAT,
            gnom_ade_sas_af FLOAT,
            gnom_adg_af FLOAT,
            gnom_adg_afr_af FLOAT,
            gnom_adg_ami_af FLOAT,
            gnom_adg_amr_af FLOAT,
            gnom_adg_asj_af FLOAT,
            gnom_adg_eas_af FLOAT,
            gnom_adg_fin_af FLOAT,
            gnom_adg_mid_af FLOAT,
            gnom_adg_nfe_af FLOAT,
            gnom_adg_remaining_af FLOAT,
            gnom_adg_sas_af FLOAT,
            hgnc_id VARCHAR,
            hgvsc VARCHAR,
            hgvsp VARCHAR,
            impact VARCHAR,
        ...
        CREATE TABLE variants_enriched (
            ...
            vep_gnom_ade_afr_af FLOAT,
            vep_gnom_ade_amr_af FLOAT,
            vep_gnom_ade_asj_af FLOAT,
            vep_gnom_ade_eas_af FLOAT,
            vep_gnom_ade_fin_af FLOAT,
            vep_gnom_ade_mid_af FLOAT,
            vep_gnom_ade_nfe_af FLOAT,
            vep_gnom_ade_remaining_af FLOAT,
            vep_gnom_ade_sas_af FLOAT,
            vep_gnom_adg_af FLOAT,
            vep_gnom_adg_afr_af FLOAT,
            vep_gnom_adg_ami_af FLOAT,
            vep_gnom_adg_amr_af FLOAT,
            vep_gnom_adg_asj_af FLOAT,
            vep_gnom_adg_eas_af FLOAT,
            vep_gnom_adg_fin_af FLOAT,
            vep_gnom_adg_mid_af FLOAT,
            vep_gnom_adg_nfe_af FLOAT,
            vep_gnom_adg_remaining_af FLOAT,
            vep_gnom_adg_sas_af FLOAT,
            vep_hgnc_id VARCHAR,
            vep_hgvsc VARCHAR,
            vep_hgvsp VARCHAR,
            vep_impact VARCHAR,
